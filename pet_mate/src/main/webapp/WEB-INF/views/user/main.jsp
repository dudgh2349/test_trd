						...
						<!-- Nav -->
							<nav id="nav">
								<ul>
									...
									<li class="current" ><a onClick="mainLogout()">LOGOUT</a></li>
								</ul>
							</nav>
...
<section id="team" class="pb-5">
    <div class="container">
        ...
        <div class="row">
 <!-- Team member -->
                     <c:forEach var="storeList" items="${userInfo.storeList}">
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title" id="storeName">${storeList.stName}</h4>
                                    <p class="card-text" id="storeAddress">${storeList.stAddress}</p>
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <h4 class="card-title" id="addTitle">${storeList.staddTitle}</h4>
                                    <p class="card-text" id="addSubTitle">${storeList.staddSubTitle}</p>
...
window.onload = function loginJWT(){
const stringData = '${userInfo}';
	if(stringData != ''){
		...
		serverCallByFetchAjax(formData, "getJWT", "post", "loginJWT");	
	}
} 


function loginJWT(jsonData){
...
function mainLogout(){
	...
	if(Info != ''){
		...
		formData.append('AccessList[0].AccessType', -1 );
		serverCallByFetch(formData, "beforeLogout", "post", "logout", accessToken);
	}
}

function createInfo(){
	document.getElementsByClass('modal-title').innerText=""
}
