						...
						<div class="row">
							...
							style="width:fit-content">
								<div class="account block"> <!-- ACCOUNT (RIGHT-CONTAINER) -->
									...
									<div><a class="sign-in button" href="#22">로그인</a>
									<div style="display : flex; justify-content: center;">
										 <img src="Resources/images/KAKAOTALK.png" alt="No Image" style ="width : 70px; margin-right: 10px; ">
										 <img src="Resources/images/naverCircle.png" alt="No Image" style ="width : 70px;">
										 
									</div>
									<a class="fb-sign-in" href="58" >
										<p><span class="fp-border" style="margin-right: 0px;"></span>Forgot Password?</p>
									</a>
									
									<a class="fb-sign-in" href="reg_User.jsp" >
										<p><span class="fp-border" style="margin-right: 0px;"></span>Please sign up?</p>
									</a>
									</div>
